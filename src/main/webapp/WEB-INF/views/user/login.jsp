			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="login.me" id="contactForm" >
							...
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="userPwd" name="userPwd" placeholder="Password" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
							</div>
