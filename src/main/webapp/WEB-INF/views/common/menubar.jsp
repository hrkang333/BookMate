...
<div  style="margin: auto; width: 1200px">
		...
		<div style="display: flex;">
			<div>
				...
				<a class="imgHome" href="${pageContext.servletContext.contextPath }/" style="margin-right: 10px"><img
					src="resources/img/logo.png" alt="" style="width: 300px;"></a>
			</div>
			<div class="searchingArea">
				...
				<form action="selectSearchKeyword.se" method="post">
					...
					<button class="btn btn-success" type="submit"
						style="height: 50px; color: black; cursor: pointer;">검색</button>
				</form>
			</div>
		</div>
		...
		<nav style="width: 1200px; text-align: center;">
			<ul class="navbar" id="tree">
				<li class="nav-item"><a class="nav-link" style=" color: #503535; font-weight: 700; font-size: 18px;"
